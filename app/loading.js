...
export default function Loading() {
  ...
  const easternEggs = [
    ...
    "PROBING OFFSHORE SERVERS...",
    "ANALYZING POLITICAL PUPPETRY...",
    "QUANTIZING MARKET EMOTIONS...",
    "SUPPRESSING MINOR REBELLIONS...",
    "IDENTIFYING HIDDEN WHALES...",
    "DOWNLOADING INTERNET MEMES... (FOR RESEARCH)",
    "CALCULATING THE MEANING OF LIFE... (42)",
    "VERIFYING SCHRÖDINGER'S CASH...",
    "UPDATING SHADOW GOVERNMENT BIOS...",
    "RECRUITING SECRET AGENTS...",
  ];
